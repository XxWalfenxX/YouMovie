      ...
      <template v-slot:after>
        ...
        >
          ...
          <q-tab-panel name="modify" style="padding: 0">
            <EditarPeli />
            <!-- Componente para modificar película -->
          </q-tab-panel>

          <q-tab-panel name="remove" style="padding: 0">
            <EliminarPelicula />
            <!-- Componente para eliminar película -->
          </q-tab-panel>
        </q-tab-panels>
      </template>
    </q-splitter>
